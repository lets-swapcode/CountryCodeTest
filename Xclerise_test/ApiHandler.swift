...
class apiHandler{
    ...
    let url_countries = "https://restcountries.com/v3.1/all"
...
//MARK: Optimised
//Note - This model flow can be optimised even further where we can avoid processing of data. But due to time restriction, I had to skipped it. 
struct CountryLite{
    let name: String
    let currency: String
    let symbol: String
...
struct Currencies: Codable {
    ...
    func getFirstNonNullCurrencyName() -> (String,String) {
        // Using Mirror to reflect on properties
